...
import { S as SiteHeader, C as ClientsRibbon, F as Footer, a as FloatingCTA, L as LionInteractions, i as iconUrl, D as DotMark, M as MouthMark, s as svcExec, m as svcAuthor } from "./router-CisfMEll.mjs";
...
import { V as Volume2, A as ArrowRight, b as Camera, O as Film, W as Palette, w as Sparkles, _ as Printer, $ as Gift, D as Monitor, a0 as Scissors, h as Minus, i as Plus, y as Check, z as ArrowUpRight, P as Phone, j as ClipboardList, F as FilePenLine, U as Users, k as Map, R as Rocket, l as ChartLine, m as Trophy, f as MessageSquareHeart } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden bg-navy-deep pt-20 text-cream md:pt-28", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto grid max-w-7xl items-center gap-12 px-6 py-16 lg:grid-cols-[1.1fr_1fr] lg:py-24", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: LION_URL, alt: "Roaring lion — The Big Mouth PR", className: "relative mx-auto w-full max-w-[520px] animate-lion-roar drop-shadow-[0_30px_60px_rgba(253,95,8,0.35)]" }),
...
function Overview() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative bg-white py-20 md:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
...
const subServices = [{
  ...
  details: ["Brand portrait sessions & headshot suites", "Product & packaging photography", "Event & activation coverage", "Campaign & lookbook shoots", "Retouching & colour grading"]
}, {
  icon: Film,
  title: "Videography",
  ...
  details: ["Video editing & colour grading", "Sound design & audio mixing", "Photo retouching & compositing", "Transcription & captioning", "Format mastering for all platforms"]
}];
function SubServices() {
  const [open, setOpen] = reactExports.useState(0);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "sub-services", className: "relative bg-[oklch(0.98_0.005_240)] py-20 md:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-3 max-w-2xl font-display text-4xl font-black tracking-tight text-navy-deep md:text-5xl", children: [
          "Six production disciplines. ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold", children: "One" }),
          " creative partner."
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-sm text-sm text-navy-deep/65", children: "Pick à la carte or bundle them all. Each discipline is a future Big Mouth page of its own — preview them below." })
    ] }),
        ...
        isOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 border-t border-navy-deep/10 px-6 py-7 md:grid-cols-[1.4fr_1fr] md:px-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start justify-between gap-4 rounded-xl bg-navy-deep p-6 text-cream", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-cream/75", children: [
              ...
              " is coming soon — full deliverables, samples and pricing."
            ] }),
...
function WhyUs() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden bg-navy-deep py-20 text-cream md:py-28", children: [
...
function Process() {
  const steps = [{
    icon: Phone,
    t: "Discovery Call",
    d: "60-min strategy kickoff. We listen, you roar."
  }, {
    icon: ClipboardList,
    t: "Onboarding",
    d: "Brand audit, asset intake, stakeholder interviews."
  }, {
    icon: FilePenLine,
    t: "Scope Finalized",
    d: "Crystal-clear SOW, deliverables and timelines."
  }, {
    icon: Users,
    t: "Team Assigned",
    d: "Senior pod — strategist, writer, designer, publicist."
  }, {
    icon: Map,
    t: "Plan Built",
    d: "12-month brand roadmap with monthly KPIs."
  }, {
    icon: Rocket,
    t: "Execute",
    d: "Content, pitches, shoots, posts, placements — live."
  }, {
    icon: ChartLine,
    t: "Optimize in Real Time",
    d: "Weekly data reviews. Pivot fast, scale what works."
  }, {
    icon: Trophy,
    t: "Complete & Report",
    d: "Quarterly impact report. Wins, learnings, next bets."
  }, {
    icon: MessageSquareHeart,
    t: "Feedback Loop",
    d: "NPS, candid debrief, renewal & expansion."
  }];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "process", className: "relative bg-white py-20 md:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
...
const portfolioItems = [{
  ...
  win: "Viral campaign with 5M+ organic views in 72 hours"
}, {
  img: portfolio2,
  name: "James Wright",
  role: "Photographer",
  win: "Album art & campaign for Grammy-nominated artist"
}, {
  img: portfolio3,
  name: "Anya Kapoor",
  role: "Event Producer",
  win: "NYFW activation with 2,000+ attendees and 40+ media hits"
}, {
  img: portfolio4,
  name: "Luis Torres",
  role: "Director of Photography",
  win: "Cinematography for Sundance-selected short film"
}, {
  img: svcExec,
  role: "Video Director",
  name: "Raj Patel",
  win: "3 brand films for Fortune 500 client — 12M combined views"
}, {
  img: svcAuthor,
  role: "Print Designer",
  name: "Mia Chen",
  win: "Award-winning annual report redesign for public company"
}];
function Portfolio() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "portfolio", className: "relative bg-[oklch(0.98_0.005_240)] py-20 md:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
...
function Consult() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "consult", className: "relative overflow-hidden bg-navy-deep py-24 text-cream", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "aria-hidden": true, className: "pointer-events-none absolute inset-0 opacity-[0.05]", style: {
      backgroundImage: `url(${ICON_URL})`,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto grid max-w-7xl items-center gap-14 px-6 lg:grid-cols-[1fr_1.1fr]", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("form", { onSubmit: (e) => {
        e.preventDefault();
        setSubmitted(true);
      }, className: "rounded-3xl border border-cream/10 bg-cream/[0.04] p-7 shadow-luxe backdrop-blur md:p-9", children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-10 text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "submit", className: "mt-6 inline-flex w-full items-center justify-center gap-2 rounded-full bg-gold px-7 py-4 text-sm font-bold uppercase tracking-wider text-navy-deep shadow-gold transition hover:scale-[1.02]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Volume2, { className: "h-4 w-4" }),
          " Let's make it"
        ] }),
