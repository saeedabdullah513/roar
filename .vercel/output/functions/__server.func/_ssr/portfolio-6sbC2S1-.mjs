...
import { S as SiteHeader, F as Footer, a as FloatingCTA, L as LionInteractions, D as DotMark, g as caseTerraSquare, h as caseUsaToday, j as caseForbes, k as caseBrandBook, l as branding2, m as branding, n as corporateHeadshot, o as forbes, w as website } from "./router-CiC45WVn.mjs";
...
const projects = [{
  ...
  description: "Put a financial services brand on the world's most iconic billboard. 30-second spot. 340K daily impressions. Instant credibility.",
  img: caseTerraSquare,
  ...
  detail: ["Terra Securities, a boutique investment firm, needed instant brand authority in a market dominated by household names. We proposed and executed a full Times Square billboard takeover — a 30-second animated spot running on a premium screen at the intersection of 7th Avenue and 47th Street.", "The creative paired bold typography with the firm's signature teal-and-gold palette against the chaos of Times Square, ensuring the brand stopped pedestrians and drivers alike. We handled media buying, content production, licensing, and rights clearance end-to-end in under three weeks.", "The billboard went live on a Tuesday morning. By Friday, the CEO had interview requests from Bloomberg and CNBC. Brand awareness metrics among their target demographic jumped from 12% to 41% within the campaign's two-week run."]
}, {
  slug: "usa-today-keri-murphy",
  title: "USA Today — Keri Murphy Feature",
  category: "PR & Media Placement",
  description: "Secured a full-length USA Today feature for media entrepreneur Keri Murphy, anchoring the launch of her visibility network.",
  img: caseUsaToday,
  ...
  category: "PR & Media Placement",
  description: "Positioned a rising fintech executive as a Forbes-featured thought leader with a full editorial profile.",
  img: caseForbes,
  ...
  description: "A comprehensive 64-page brand identity book covering visual language, tone, typography, and application guidelines.",
  img: caseBrandBook,
  ...
  category: "Creative Production",
  description: "Full brand identity package — logo, color palette, typography system, and application mockups for a consumer brand.",
  img: branding,
  ...
  description: "Corporate headshot and environmental portrait series for a leadership team, shot on location with natural and studio lighting.",
  ...
  slug: "forbes-media-placement",
  title: "Forbes Media Placement",
  category: "PR & Media Placement",
  description: "Secured a Forbes editorial mention for a tech founder, positioning them as an industry voice in mainstream business media.",
  img: forbes,
...
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative overflow-hidden pt-24 pb-16 md:pt-36 md:pb-24", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start gap-6 md:flex-row md:items-end md:justify-between", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "mt-5 font-display text-3xl sm:text-4xl md:text-6xl font-black uppercase leading-[0.95] md:text-7xl", children: [
        "The work ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold italic", children: "speaks." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 max-w-lg text-lg text-cream/70", children: "Nine projects. Real brands. Measurable noise. From Times Square billboards to Forbes features, this is what happens when strategy meets volume." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/contact-us", className: "inline-flex items-center gap-2 rounded-full bg-gold px-6 py-3.5 text-sm font-bold uppercase tracking-wider text-navy-deep shadow-gold transition hover:scale-[1.03]", children: [
      "Start your project ",
...
function ProjectsGrid() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "pb-24 md:pb-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-10 flex flex-wrap items-center gap-3", children: categories.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setFilter(c), className: `rounded-full px-5 py-2 text-xs font-semibold uppercase tracking-wider transition ${filter === c ? "bg-gold text-navy-deep" : "border border-cream/20 text-cream/60 hover:border-cream/50 hover:text-cream"}`, children: c }, c)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 sm:grid-cols-2 lg:grid-cols-3", children: filtered.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/portfolio/$slug", params: {
      slug: p.slug
    }, className: "group relative overflow-hidden rounded-2xl bg-cream/5 ring-1 ring-cream/10 transition hover:-translate-y-1 hover:ring-gold", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-56 overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute right-4 top-4 rounded-full bg-gold/90 p-2 text-navy-deep opacity-0 transition group-hover:opacity-100", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { className: "h-4 w-4" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-[0.25em] text-gold", children: p.category }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-2 font-display text-xl font-bold text-cream group-hover:text-gold transition-colors", children: p.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm leading-relaxed text-cream/65", children: p.description }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-gold", children: [
          "View case study ",
