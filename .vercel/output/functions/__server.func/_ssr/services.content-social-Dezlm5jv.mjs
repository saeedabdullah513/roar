...
import { S as SiteHeader, C as ClientsRibbon, F as Footer, a as FloatingCTA, L as LionInteractions, i as iconUrl, D as DotMark, M as MouthMark, c as svcContent, s as svcExec } from "./router-DGUNaTGD.mjs";
...
import { V as Volume2, A as ArrowRight, M as Megaphone, b as Camera, Y as MicVocal, T as TrendingUp, a as Crown, I as Instagram, _ as Youtube, e as Minus, P as Plus, d as Check, v as ArrowUpRight, h as Phone, w as ClipboardList, x as FilePenLine, U as Users, y as Map, R as Rocket, u as ChartLine, $ as Trophy, k as MessageSquareHeart, L as LoaderCircle } from "../_libs/lucide-react.mjs";
...
function SubServices() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "sub-services", className: "relative bg-[oklch(0.98_0.005_240)] py-20 md:py-24 xl:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-sm text-sm text-navy-deep/65", children: "Content & Social isn't sporadic posting — it is a full-time global multimedia operation. Each sub-service is a future Big Mouth page of its own — preview them below." })
    ] }),
