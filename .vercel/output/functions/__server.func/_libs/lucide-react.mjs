...
const BookMarked = createLucideIcon("book-marked", __iconNode$T);
const __iconNode$S = [
...
const MessageSquareHeart = createLucideIcon("message-square-heart", __iconNode$p);
const __iconNode$o = [
  [
    "path",
    {
