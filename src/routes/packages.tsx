                ...
                <div className="mt-6 grid gap-4">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    ...
                    <label className="block">
                      ...
                      <input required name="phone" type="tel" onInput={(e) => { (e.target as HTMLInputElement).value = (e.target as HTMLInputElement).value.replace(/[^\d+]/g, ""); }} className="mt-1.5 w-full rounded-xl border border-cream/15 bg-white px-3 py-2.5 text-sm text-navy-deep outline-none focus:border-gold" />
                    </label>
                  </div>
                  <label className="block">
