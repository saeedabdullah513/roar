...
import { V as Volume2, A as ArrowRight, M as Megaphone, b as Camera, _ as MicVocal, T as TrendingUp, a as Crown, I as Instagram, $ as Youtube, e as Minus, P as Plus, d as Check, g as ArrowUpRight, h as Phone, w as ClipboardList, x as FilePenLine, n as Users, y as Map, R as Rocket, v as ChartLine, a1 as Trophy, k as MessageSquareHeart, K as ChevronLeft, O as ChevronRight, L as LoaderCircle } from "../_libs/lucide-react.mjs";
...
const subServices = [{
  ...
  details: ["UGC strategy & campaign design", "Creator identification & outreach", "Content rights & licensing management", "Influencer program build & optimization"]
}, {
  icon: Instagram,
  ...
  details: ["Channel strategy & content pillars", "Scripting, filming & editing", "SEO optimization & thumbnail design", "Community management & growth tactics"]
}, {
  icon: Megaphone,
  title: "Always-On Content Engine",
  short: "Find out what the Always-On Content Engine can do.",
  details: ["Monthly shoot days (photo + video)", "Multi-platform content repurposing", "Cross-channel distribution & scheduling", "Weekly analytics & optimization reviews"]
}];
