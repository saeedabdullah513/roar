...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-L86dsIn2.mjs");
...
const manifest = {
  "51496c6ca2b5055341948a46205d4083f7301883d1e1b16d00d2abd04c02d91c": {
    ...
    importer: () => import("./contact.functions-Bau_RTHU.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BH7C75aK.mjs").then((n) => n.u),
    import("./start-DvvyeQNV.mjs"),
