...
import { l as logoUrl, N as NavigationMenu, b as NavigationMenuList, c as NavigationMenuItem, d as NavigationMenuTrigger, e as cn, f as NavigationMenuContent, g as NavigationMenuLink, s as svcExec, h as svcMedia, j as svcContent, k as svcCreative, m as svcAuthor, n as svcDigital, i as iconUrl, o as fahhhSound } from "./router-Jw3gLdqb.mjs";
...
function Hero() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative w-full overflow-hidden bg-navy-deep py-16 text-cream md:py-24 lg:py-28", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 mx-auto grid max-w-7xl gap-8 px-6 lg:grid-cols-[1.05fr_1fr] lg:items-center lg:gap-16 xl:gap-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-reveal relative", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: lionUrl, alt: "", "aria-hidden": true, className: "pointer-events-none absolute right-0 hidden h-[220px] w-auto animate-lion-roar drop-shadow-[0_20px_50px_rgba(253,95,8,0.45)] md:block md:top-16 md:h-[200px] lg:-right-8 lg:top-12 lg:h-[280px] xl:-right-12 xl:h-[340px]" }),
