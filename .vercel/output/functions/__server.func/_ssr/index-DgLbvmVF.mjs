...
import { l as logoUrl, N as NavigationMenu, b as NavigationMenuList, c as NavigationMenuItem, d as NavigationMenuTrigger, e as cn, f as NavigationMenuContent, g as NavigationMenuLink, s as svcExec, h as svcMedia, j as svcContent, k as svcCreative, m as svcAuthor, n as svcDigital, i as iconUrl, o as fahhhSound } from "./router-PuIKTmEh.mjs";
...
function Hero() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative w-full overflow-hidden bg-navy-deep py-20 text-cream md:py-28 lg:py-32 xl:min-h-[650px]", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 mx-auto grid max-w-7xl gap-8 px-6 lg:grid-cols-[1.05fr_1fr] lg:items-center lg:gap-16 xl:gap-20", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "story", className: "relative bg-white py-28 md:py-32", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto grid max-w-7xl items-center gap-16 px-6 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setOpen(true), className: "group relative block w-full overflow-hidden rounded-2xl shadow-luxe", "aria-label": "Play our story", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: storyThumb, alt: "The Big Mouth PR story", loading: "lazy", className: "h-[300px] w-full object-cover transition duration-700 group-hover:scale-105 md:h-[400px] lg:h-[520px]" }),
