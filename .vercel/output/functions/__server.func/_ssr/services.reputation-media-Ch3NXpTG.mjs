...
import { V as Volume2, A as ArrowRight, W as ShieldCheck, N as Newspaper, T as TrendingUp, M as Megaphone, a as Crown, _ as MicVocal, e as Minus, P as Plus, d as Check, g as ArrowUpRight, h as Phone, w as ClipboardList, x as FilePenLine, n as Users, y as Map, R as Rocket, v as ChartLine, a0 as Trophy, k as MessageSquareHeart, K as ChevronLeft, O as ChevronRight, L as LoaderCircle } from "../_libs/lucide-react.mjs";
...
function Overview() {
  const pillars = [{
    icon: ShieldCheck,
    t: "Trust",
    d: "Build credibility that every stakeholder, partner and investor instantly recognises."
  }, {
    icon: Newspaper,
    t: "Visibility",
...
const subServices = [{
  ...
  details: ["Google, Trustpilot, Yelp & G2 monitoring", "Review response strategy & templates", "Sentiment analysis & reputation scoring", "Review generation & advocacy programmes"]
}, {
  icon: MicVocal,
