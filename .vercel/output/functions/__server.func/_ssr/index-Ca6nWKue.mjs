...
import { p as logoUrl, N as NavigationMenu, q as NavigationMenuList, r as cn, t as NavigationMenuItem, u as NavigationMenuLink, s as svcExec, b as svcMedia, c as svcContent, d as svcCreative, e as svcAuthor, f as svcDigital, i as iconUrl, g as caseTerraSquare, h as caseUsaToday, j as caseForbes, k as caseBrandBook, v as roarSfx } from "./router-Z-qb-h4g.mjs";
...
import { c as Menu, C as ChevronDown, V as Volume2, a as Crown, N as Newspaper, M as Megaphone, b as Camera, B as BookOpen, E as Earth, i as Star, L as LoaderCircle, A as ArrowRight, D as Play, X, J as ChevronLeft, K as ChevronRight, O as UtensilsCrossed, T as TrendingUp, h as ShieldCheck, H as Heart, Q as Building2, W as Scale, Y as MicVocal, S as Sparkles, e as Minus, P as Plus, I as Instagram, G as Linkedin, Z as Youtube } from "../_libs/lucide-react.mjs";
...
const storyVideo = "/assets/the-big-mouth-pr-final-cut-DXdg4V6f.mp4";
...
function Story() {
  const [open, setOpen] = reactExports.useState(false);
  const [posterThumb, setPosterThumb] = reactExports.useState(storyThumb);
    ...
    const capture = () => {
      if (v.videoWidth) {
        ...
        if (ctx) {
          ...
          setPosterThumb(c.toDataURL("image/jpeg", 0.8));
        }
      }
    };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "story", className: "relative bg-white py-24 md:py-28 xl:py-20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto grid max-w-7xl items-center gap-12 px-6 lg:grid-cols-2 lg:gap-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: onStoryOpen, className: "group relative block w-full max-w-lg overflow-hidden rounded-2xl shadow-luxe lg:max-w-[600px]", "aria-label": "Play our story", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: posterThumb, alt: "The Big Mouth PR story", loading: "lazy", className: "h-[300px] w-full object-cover transition duration-700 group-hover:scale-105 md:h-[400px] lg:h-[520px]" }),
...
function Testimonials() {
  ...
  const capturePoster = (video, index) => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-7xl px-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-4", children: testimonials.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "group relative aspect-[9/16] overflow-hidden rounded-3xl bg-black shadow-luxe", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("video", { ref: (el) => {
          ...
          if (el) capturePoster(el);
        }, src: t.video, playsInline: true, preload: "metadata", poster: t.img, className: "absolute inset-0 h-full w-full object-cover" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handlePlay(i), className: "absolute left-1/2 top-[55%] -translate-x-1/2 -translate-y-1/2 grid h-14 w-14 place-items-center rounded-full bg-gold/95 text-navy-deep transition group-hover:scale-110", "aria-label": `Play ${t.name} testimonial`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "ml-0.5 h-6 w-6 fill-current" }) })
      ] }, t.name)) })
    ] })
  ] });
}
