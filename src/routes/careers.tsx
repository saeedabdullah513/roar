            ...
            <form onSubmit={handleSubmit} className="rounded-3xl bg-cream/5 p-8 md:p-10">
              ...
              <div className="mt-8 grid gap-5">
                ...
                <label className="block">
                  ...
                  <input required name="phone" type="tel" onInput={(e) => { (e.target as HTMLInputElement).value = (e.target as HTMLInputElement).value.replace(/[^\d+]/g, ""); }} className="mt-1.5 w-full rounded-xl border border-cream/15 bg-navy-deep/40 px-4 py-3 text-sm text-cream placeholder:text-cream/45 focus:border-gold focus:outline-none" placeholder="+1 (555) 000-0000" />
                </label>
                <label className="block">
