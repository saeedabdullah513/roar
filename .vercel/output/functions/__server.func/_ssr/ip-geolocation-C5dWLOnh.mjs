import { a as createServerFn, T as TSS_SERVER_FUNCTION, g as getServerFnById } from "./server-DuBOblra.mjs";
...
async function fetchIpGeolocation() {
  try {
    const res = await fetch("https://ipwhois.app/json/", { signal: AbortSignal.timeout(5e3) });
    if (!res.ok) return {};
    const json = await res.json();
    return {
      ipAddress: json.ip || void 0,
      ipCity: json.city || void 0,
      ipRegion: json.region || void 0,
