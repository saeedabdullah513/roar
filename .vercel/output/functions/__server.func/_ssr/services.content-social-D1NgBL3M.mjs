...
import { V as Volume2, A as ArrowRight, M as Megaphone, b as Camera, _ as MicVocal, T as TrendingUp, a as Crown, I as Instagram, $ as Youtube, e as Minus, P as Plus, d as Check, g as ArrowUpRight, h as Phone, w as ClipboardList, x as FilePenLine, n as Users, y as Map, R as Rocket, v as ChartLine, a0 as Trophy, k as MessageSquareHeart, K as ChevronLeft, O as ChevronRight, L as LoaderCircle } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "sub-services", className: "relative bg-[oklch(0.98_0.005_240)] py-20 md:py-24 xl:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-3 max-w-2xl font-display text-2xl sm:text-3xl md:text-5xl font-black tracking-tight text-navy-deep md:text-5xl", children: [
          "Six Channels. ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold", children: "One Voice That Doesn't Shut" }),
          " Up."
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-sm text-sm text-navy-deep/65", children: "Content & Social isn't sporadic posting. It's a 360° system — LinkedIn authority, Instagram reach, YouTube depth, podcast presence, UGC amplification, and influencer partnerships — engineered for perpetual visibility." })
    ] }),
