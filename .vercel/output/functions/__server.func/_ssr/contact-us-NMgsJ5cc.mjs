...
import { a as createServerFn, T as TSS_SERVER_FUNCTION, g as getServerFnById } from "./server-BIClXni5.mjs";
import { S as SiteHeader, C as ClientsRibbon, F as Footer, a as FloatingCTA, L as LionInteractions, i as iconUrl, D as DotMark, M as MouthMark } from "./router-CisfMEll.mjs";
import { l as lionUrl } from "./lion-roar-IYwTvOU2.mjs";
import "../_libs/seroval.mjs";
import { P as Phone, d as Mail, e as MapPin, f as MessageSquareHeart, A as ArrowRight, L as LoaderCircle, V as Volume2, g as Clock, h as Minus, i as Plus } from "../_libs/lucide-react.mjs";
...
function Location() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative overflow-hidden bg-[oklch(0.98_0.005_240)] py-20 md:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid items-end gap-10 lg:grid-cols-[1.2fr_1fr]", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-navy-deep/70 md:text-lg", children: "Based in New York City with clients across three continents. We meet in person by appointment, work remotely every day, and show up everywhere that matters." })
    ] }),
