...
import { V as Volume2, A as ArrowRight, b as Camera, a7 as Film, a8 as Palette, S as Sparkles, a9 as Printer, a2 as Gift, a4 as Monitor, aa as Scissors, e as Minus, P as Plus, d as Check, g as ArrowUpRight, h as Phone, x as FilePenLine, n as Users, w as ClipboardList, R as Rocket, K as ChevronLeft, O as ChevronRight, L as LoaderCircle } from "../_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto grid max-w-7xl items-center gap-12 px-6 py-16 lg:grid-cols-[1.1fr_1fr] lg:py-24", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 inline-flex items-center gap-3 rounded-full border border-cream/15 bg-cream/5 px-4 py-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-bold uppercase tracking-[0.35em] text-cream/75", children: "Service · Creative Production" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "mt-6 font-display text-3xl sm:text-4xl md:text-6xl font-black leading-[0.95] tracking-tight md:text-7xl", children: [
          "Your brand is a ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold", children: "production." }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-6 max-w-xl text-lg text-cream/75 md:text-xl", children: [
          "Photography, videography, print design, experiential marketing and custom merchandise — all produced in-house with the same obsessive attention to detail that makes every frame, every page and every activation feel ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold font-semibold", children: "unforgettable." })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 grid max-w-md grid-cols-1 gap-6 sm:grid-cols-3", children: [{
          ...
          k: "60+",
          v: "Brands brought to life"
        }, {
          k: "48h",
          v: "Avg. turnaround time"
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-4 left-1/2 -translate-x-1/2 rounded-full bg-cream px-5 py-2 text-xs font-bold uppercase tracking-[0.3em] text-navy-deep shadow-luxe", children: "Made to be seen." })
      ] })
    ] })
  ] });
}
function Overview() {
  const pillars = [{
    icon: Camera,
    t: "Photography",
    d: "Studio-grade portraits, product shots and campaign visuals that stop the scroll."
  }, {
    icon: Film,
    t: "Videography",
    d: "Cinematic brand films, reels, testimonials and event coverage that tell your story in motion."
  }, {
    icon: Palette,
    t: "Print & Design",
    d: "Magazines, brochures, packaging and signage that feel premium in hand — not just on screen."
  }, {
    icon: Sparkles,
    t: "Experiential",
    d: "Pop-ups, activations, launch events and merch drops that people line up for."
  }];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative bg-white py-20 md:py-24 xl:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid items-end gap-10 lg:grid-cols-[1.2fr_1fr]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-3 font-display text-2xl sm:text-3xl md:text-5xl font-black tracking-tight text-navy-deep md:text-5xl", children: [
          "A full-service creative studio ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold", children: "under one" }),
          " roof."
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-navy-deep/70 md:text-lg", children: "Creative Production at The Big Mouth PR is more than a photoshoot. It's an integrated engine — photography, video, print, experiential and merch — designed so every asset your brand touches feels cohesive, crafted and calibrated to convert." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-14 grid gap-5 md:grid-cols-2 lg:grid-cols-4", children: pillars.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group relative overflow-hidden rounded-2xl border border-navy-deep/10 bg-white p-7 transition hover:-translate-y-1 hover:border-gold hover:shadow-luxe", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(p.icon, { className: "h-7 w-7 text-gold" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 font-display text-2xl font-bold text-navy-deep", children: p.t }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-navy-deep/65", children: p.d })
    ] }, p.t)) })
  ] }) });
}
const subServices = [{
  ...
  details: ["Brand portrait sessions & headshot suites", "Product & packaging photography", "Event & activation coverage", "Campaign & lookbook shoots", "Retouching & color grading"]
}, {
  icon: Film,
  title: "Videography",
  short: "See what Videography can do for your brand.",
  details: ["Cinematic brand films & TVCs", "Social-first reels & shorts", "Client testimonials & case study videos", "Event highlight reels & recaps", "Animation & motion graphics"]
}, {
  icon: Printer,
  title: "Print Production",
  short: "Read more on Print Production.",
  details: ["Magazines, annual reports & coffee-table books", "Brochures, sell-sheets & one-pagers", "Signage, banners & trade-show materials", "Packaging design & structural prototypes", "Pre-press, proofing & vendor management"]
}, {
  icon: Gift,
  title: "Custom Merchandise",
  short: "Explore the full range of Custom Merchandise.",
  details: ["Custom apparel & streetwear drops", "Conference & event swag packs", "Premium corporate gifts & packaging", "Sustainable & ethically sourced options", "Fulfilment & inventory management"]
}, {
  icon: Monitor,
  title: "Experiential Marketing",
  short: "Find out more about Experiential Marketing.",
  details: ["Pop-up shops & brand activations", "Product launch events & after-parties", "Immersive brand installations", "Touring activations & roadshows", "Measurement & post-event reporting"]
}, {
  icon: Scissors,
  title: "Post-Production",
  short: "See how Post-Production polishes everything.",
  details: ["Video editing & color grading", "Sound design & audio mixing", "Photo retouching & compositing", "Transcription & captioning", "Format mastering for all platforms"]
}];
function SubServices() {
  const [open, setOpen] = reactExports.useState(0);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "sub-services", className: "relative bg-[oklch(0.98_0.005_240)] py-20 md:py-24 xl:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-3 max-w-2xl font-display text-2xl sm:text-3xl md:text-5xl font-black tracking-tight text-navy-deep md:text-5xl", children: "A Team That Handles it All." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-sm text-sm text-navy-deep/65", children: "Pick à la carte or bundle them all. The Big Mouth PR can make everything you need happen:" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4", children: subServices.map((s, i) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `overflow-hidden rounded-2xl border transition ${isOpen ? "border-gold bg-white shadow-luxe" : "border-navy-deep/10 bg-white hover:border-navy-deep/30"}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => setOpen(isOpen ? null : i), className: "flex w-full items-center gap-5 px-6 py-5 text-left md:px-8", "aria-expanded": isOpen, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `flex h-12 w-12 shrink-0 items-center justify-center rounded-xl transition ${isOpen ? "bg-gold text-navy-deep" : "bg-navy-deep/5 text-navy-deep"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(s.icon, { className: "h-5 w-5" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-xl font-bold text-navy-deep md:text-2xl", children: s.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-navy-deep/60", children: s.short })
          ] }),
        ...
        isOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 border-t border-navy-deep/10 px-6 py-7 md:grid-cols-[1.4fr_1fr] md:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "grid gap-3 sm:grid-cols-2", children: s.details.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3 text-sm text-navy-deep/80", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start justify-between gap-4 rounded-xl bg-navy-deep p-6 text-cream", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-cream/75", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-gold", children: s.title }),
              "?"
            ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-7xl px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start justify-between gap-6 md:flex-row md:items-end", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-3 max-w-3xl font-display text-2xl sm:text-3xl md:text-5xl font-black tracking-tight md:text-5xl", children: [
            "Other agencies ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic text-cream/55", children: "outsource." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            "We build it in ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold", children: "house." })
          ] })
        ] }),
...
function Process() {
  const steps = [{
    icon: Phone,
    t: "The Creative Conversation",
    d: "Tell us what you're building, launching, or trying to say. No brief required — we help shape it in the room."
  }, {
    icon: Sparkles,
    t: "Concept Development",
    d: "Moodboards, shot lists, storyboards, activation concepts. We come back with ideas that are executable, not just pretty."
  }, {
    icon: FilePenLine,
    t: "Scope & Quote",
    d: "A clear production plan — locations, crew, deliverables, timeline, costs. No surprises on shoot day or invoice day."
  }, {
    icon: Users,
    t: "Your Crew, Assembled",
    d: "Photographer, director, designer, or producer — whoever this project needs, assigned by name. You meet them before anything starts."
  }, {
    icon: ClipboardList,
    t: "Pre-Production",
    d: "Location scouting, talent coordination, prop sourcing, wardrobe, call sheets. The shoot works because the prep was done right."
  }, {
    icon: Camera,
    t: "Shoot Day",
    d: "We run a tight set. You show up, look good, trust us. We handle everything from lighting to lunch."
  }, {
    icon: Scissors,
    t: "Post-Production",
    d: "Editing, color grading, retouching, motion graphics, sound design. Delivered to spec — social crops, print resolution, web formats."
  }, {
    icon: Check,
    t: "Revisions & Sign-Off",
    d: "Two rounds of revisions built in. We refine until it's exactly right, then you give the final green light."
  }, {
    icon: Rocket,
    t: "Delivery & Deployment",
    d: "Assets handed over in every format you need. If we're also handling your content calendar or PR, they go straight into the pipeline."
  }];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "process", className: "relative bg-white py-20 md:py-24 xl:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-14 max-w-3xl", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-3 font-display text-2xl sm:text-3xl md:text-5xl font-black tracking-tight text-navy-deep md:text-5xl", children: [
        "From brief to ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold", children: '"wrap."' })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "grid gap-6 md:grid-cols-3 lg:grid-cols-3", children: steps.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "group relative rounded-2xl border border-navy-deep/10 bg-white p-6 transition hover:-translate-y-1 hover:border-gold hover:shadow-luxe", children: [
...
function Portfolio() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "portfolio", className: "relative bg-[oklch(0.98_0.005_240)] py-20 md:py-24 xl:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] font-bold uppercase tracking-[0.4em] text-gold", children: "05 — Receipts" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-3 font-display text-2xl sm:text-3xl md:text-5xl font-black tracking-tight text-navy-deep md:text-5xl", children: [
          "Work we're proud ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold", children: "to show." })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: scrollPrev, "aria-label": "Previous", className: "grid h-10 w-10 place-items-center rounded-full border border-navy-deep/20 text-navy-deep transition hover:bg-navy-deep hover:text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: "h-5 w-5" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: scrollNext, "aria-label": "Next", className: "grid h-10 w-10 place-items-center rounded-full border border-navy-deep/20 text-navy-deep transition hover:bg-navy-deep hover:text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "h-5 w-5" }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: emblaRef, className: "overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-5", children: portfolioItems.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx("article", { className: "min-w-0 shrink-0 grow-0 basis-[85%] sm:basis-[45%] lg:basis-[32%]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "group relative overflow-hidden rounded-2xl bg-navy-deep shadow-luxe", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: p.img, alt: "Portfolio", loading: "lazy", className: "h-[320px] w-full object-cover transition duration-700 group-hover:scale-105 sm:h-[400px]" }) }) }, p.img)) }) })
  ] }) });
}
function CTAStrip() {
...
function FAQ() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "faq", className: "relative bg-white py-20 md:py-24 xl:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-[1fr_1.4fr]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-3 font-display text-2xl sm:text-3xl md:text-5xl font-black tracking-tight text-navy-deep md:text-5xl", children: [
        "Answers you can ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold", children: "take to set." })
      ] }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "consult", className: "relative overflow-hidden bg-navy-deep py-20 text-cream md:py-24 xl:py-20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto grid max-w-7xl items-center gap-14 px-6 lg:grid-cols-[1fr_1.1fr]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-3 font-display text-3xl sm:text-4xl md:text-6xl font-black leading-[0.95] tracking-tight md:text-6xl", children: [
          "Your brand deserves ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold", children: "better" }),
          " than",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          "stock photos and ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "good enough." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 max-w-md text-cream/75", children: "Tell us about the project. A senior producer (not a chatbot) replies within 24 hours with a tailored scope." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex flex-wrap items-center gap-4 text-xs uppercase tracking-[0.25em] text-cream/55", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DotMark, {}),
          " No spam · No interns · No outsourcing"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("form", { onSubmit: handleConsultSubmit, className: "rounded-3xl border border-cream/10 bg-cream/[0.04] p-7 shadow-luxe backdrop-blur md:p-9", children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-10 text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-2xl font-bold", children: "Book a production consultation" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 grid gap-4 md:grid-cols-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Phone", name: "phone", type: "tel", placeholder: "+1 (555) 000-0000" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Company", name: "company", placeholder: "Atlas Ventures" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Role", name: "role", placeholder: "Creative Director" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[11px] font-bold uppercase tracking-[0.25em] text-cream/60", children: "Tell us about your project" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { name: "project", rows: 4, placeholder: "Photography, video, print, merch or experiential — give us the brief…", className: "mt-2 w-full rounded-xl border border-cream/15 bg-navy-deep/40 px-4 py-3 text-sm text-cream placeholder:text-cream/45 focus:border-gold focus:outline-none" })
        ] }),
...
function Field({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("input", { name, type, required: true, placeholder, onInput: type === "tel" ? (e) => {
      e.target.value = e.target.value.replace(/[^\d+]/g, "");
    } : void 0, className: "mt-2 w-full rounded-xl border border-cream/15 bg-navy-deep/40 px-4 py-3 text-sm text-cream placeholder:text-cream/45 focus:border-gold focus:outline-none" })
  ] });
}
function CreativeProductionPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "lion-cursor bg-white text-navy-deep", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SubServices, {}),
...
export {
  CreativeProductionPage as component
};
