...
import { S as SiteHeader, C as ClientsRibbon, F as Footer, a as FloatingCTA, L as LionInteractions, i as iconUrl, D as DotMark, M as MouthMark, s as svcExec, d as svcCreative } from "./router-FPk8vJkk.mjs";
...
import { V as Volume2, A as ArrowRight, S as Sparkles, Y as MicVocal, j as MapPin, a0 as Gift, a1 as Music, b as Camera, e as Minus, P as Plus, d as Check, v as ArrowUpRight, h as Phone, w as ClipboardList, x as FilePenLine, U as Users, y as Map, R as Rocket, u as ChartLine, $ as Trophy, k as MessageSquareHeart, L as LoaderCircle } from "../_libs/lucide-react.mjs";
...
const portfolioItems = [{
  img: portfolio1,
  name: "Atlas Summit",
  role: "Product Launch — NYC",
  win: "1,200 attendees, 40+ media hits, 8M social reach"
}, {
  img: portfolio2,
  name: "Lumina Nights",
  role: "Pop-Up Tour — 5 Cities",
  win: "15K visitors across 5 cities, 92% positive sentiment"
}, {
  img: portfolio3,
  name: "Vega Music Fest",
  role: "Brand Activation — Austin",
  win: "50K audience, 300K+ social impressions, sold-out merch"
}, {
  img: portfolio4,
  name: "NorthStar Retreat",
  role: "VIP Executive Event",
  win: "200 C-suite guests, 4 new strategic partnerships"
}, {
  img: svcExec,
  role: "Immersive Installation",
  name: "Echo House",
  win: "Featured in Architectural Digest, 3-week waitlist"
}, {
  img: svcCreative,
  role: "Conference Takeover",
  name: "TechFront",
  win: "1,800 booth visits, 450 qualified leads captured"
}];
function Portfolio() {
