...
import { R as Route, S as SiteHeader, F as Footer, a as FloatingCTA, L as LionInteractions, y as projects, D as DotMark } from "./router-B07WcNAi.mjs";
import { L as Link } from "../_libs/tanstack__react-router.mjs";
import { ad as ArrowLeft, d as Check, ae as ExternalLink, K as ChevronLeft, O as ChevronRight, A as ArrowRight, g as ArrowUpRight } from "../_libs/lucide-react.mjs";
  ...
  if (!project) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "lion-cursor bg-navy-deep text-cream", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "flex min-h-[60vh] items-center justify-center pt-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl sm:text-3xl md:text-5xl font-black", children: "Project not found" }),
...
function HeroImage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative h-[50vh] min-h-[320px] w-full overflow-hidden md:min-h-[420px] md:h-[65vh]", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-8 left-0 right-0 px-6 md:bottom-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-4xl", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-3 font-display text-2xl sm:text-3xl md:text-5xl font-black uppercase leading-[1.05] text-cream md:text-6xl", children: project.title })
    ] }) })
  ] });
}
function Content({
...
function CTA() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-navy-deep py-20 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-2xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-2xl sm:text-3xl md:text-5xl font-black text-cream md:text-5xl", children: [
      "Ready to make ",
