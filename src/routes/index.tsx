  ...
  return (
    <footer className="bg-navy-deep pb-24 pt-20 text-cream/70 md:pb-10">
      <div className="mx-auto grid max-w-7xl gap-10 px-6 md:grid-cols-4">
        ...
        <FooterCol title="Get loud" items={[{ label: "Book a Call", href: "/contact-us#form" }, { label: "sales@thebigmouthpr.com", href: "mailto:sales@thebigmouthpr.com" }, { label: "+1 (332) 587-1425", href: "tel:+13325871425" }, { label: "2626 E 82nd St Ste#230, Bloomington, MN 55425", href: "https://maps.google.com/?q=2626+E+82nd+St+Ste+230+Bloomington+MN+55425" }]} />
      </div>
