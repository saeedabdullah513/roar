...
import { l as logoUrl, N as NavigationMenu, b as NavigationMenuList, c as NavigationMenuItem, d as NavigationMenuTrigger, e as cn, f as NavigationMenuContent, g as NavigationMenuLink, s as svcExec, h as svcMedia, j as svcContent, k as svcCreative, m as svcAuthor, n as svcDigital, i as iconUrl, r as roarSfx } from "./router-uQDM0Ce4.mjs";
...
import { c as Menu, V as Volume2, C as ChevronDown, a as Crown, N as Newspaper, M as Megaphone, b as Camera, B as BookOpen, E as Earth, g as Star, L as LoaderCircle, A as ArrowRight, z as Play, X, J as ChevronLeft, K as ChevronRight, O as UtensilsCrossed, T as TrendingUp, f as ShieldCheck, H as Heart, Q as Building2, W as Scale, Y as MicVocal, S as Sparkles, Z as Quote, e as Minus, P as Plus, I as Instagram, G as Linkedin, _ as Youtube } from "../_libs/lucide-react.mjs";
...
function Story() {
  const [open, setOpen] = reactExports.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "story", className: "relative bg-white py-24 md:py-28 xl:py-20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto grid max-w-7xl items-center gap-12 px-6 lg:grid-cols-2 lg:gap-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setOpen(true), className: "group relative block w-full max-w-lg overflow-hidden rounded-2xl shadow-luxe lg:max-w-[600px]", "aria-label": "Play our story", children: [
...
function Services() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "services", className: "relative overflow-hidden bg-white py-20 text-navy-deep md:py-24 xl:py-20", children: [
...
function Industries() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "industries", className: "relative bg-white py-20 text-navy-deep md:py-24 xl:py-20 border-t border-navy-deep/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start justify-between gap-6 md:flex-row md:items-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "inline-flex items-center gap-2 text-xs uppercase tracking-[0.4em] text-gold", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DotMark, {}),
...
function Portfolio() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "portfolio", className: "bg-white py-24 md:py-28 xl:py-20 border-t border-navy-deep/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start justify-between gap-6 md:flex-row md:items-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "inline-flex items-center gap-2 text-xs uppercase tracking-[0.4em] text-gold", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DotMark, {}),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-14 grid gap-5 md:grid-cols-12", children: items.map((it, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#", className: `group relative block overflow-hidden rounded-2xl shadow-luxe ${i === 0 ? "md:col-span-7 md:row-span-2 portfolio-hero" : i === 1 ? "md:col-span-5 portfolio-sm" : "md:col-span-5 md:col-start-8 portfolio-sm"}`, children: [
...
function CaseStudies() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden bg-white py-20 text-navy-deep md:py-24 xl:py-20 border-t border-navy-deep/5", children: [
...
function Testimonials() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden bg-navy-deep py-24 text-cream md:py-28 xl:py-20", children: [
...
function FAQ() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "faq", className: "bg-white py-24 md:py-28 xl:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-6xl gap-16 px-6 lg:grid-cols-[1fr_1.4fr]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "inline-flex items-center gap-2 text-xs uppercase tracking-[0.4em] text-gold", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DotMark, {}),
        " FAQ"
...
function FinalCTA() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "consult", className: "relative overflow-hidden bg-navy-deep py-24 text-cream md:py-28 xl:py-20", children: [
