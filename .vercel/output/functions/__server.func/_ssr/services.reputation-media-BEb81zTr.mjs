...
import { S as SiteHeader, C as ClientsRibbon, F as Footer, a as FloatingCTA, L as LionInteractions, i as iconUrl, D as DotMark, M as MouthMark, h as svcMedia, s as svcExec } from "./router-CisfMEll.mjs";
...
import { V as Volume2, A as ArrowRight, S as ShieldCheck, N as Newspaper, s as TrendingUp, M as Megaphone, a as Crown, v as MicVocal, h as Minus, i as Plus, y as Check, z as ArrowUpRight, P as Phone, j as ClipboardList, F as FilePenLine, U as Users, k as Map, R as Rocket, l as ChartLine, m as Trophy, f as MessageSquareHeart } from "../_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-3 max-w-2xl font-display text-4xl font-black tracking-tight text-navy-deep md:text-5xl", children: [
          "Six sub-services. ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold", children: "One unshakeable" }),
          " reputation."
        ] })
      ] }),
...
const portfolioItems = [{
  ...
  win: "Forbes cover story + 4 speaking invites in 60 days"
}, {
  img: portfolio2,
  name: "James Whitfield",
  role: "Founder, Whitfield Capital",
  win: "Wikipedia page approved + $20M fund close"
}, {
  img: portfolio3,
  name: "Nina Patel",
  role: "Partner, Apex Ventures",
  win: "Bloomberg profile + crisis turnaround in 48 hours"
}, {
  img: portfolio4,
  name: "Omar Hassan",
  role: "Tech Entrepreneur",
  win: "TechCrunch exclusive + Times Square billboard campaign"
}, {
  img: svcMedia,
  name: "Rachel Kim",
  role: "Author & Advocate",
  win: "WSJ bestseller list + 200+ press placements"
}, {
  img: svcExec,
  name: "Daniel Cruz",
  role: "CEO, Cruz Holdings",
  win: "NYT mention + 85% positive sentiment recovery"
}];
function Portfolio() {
