...
const reel4 = "/assets/reel-4-D2EywAGA.jpg";
let fahhhAudio = null;
function playRoar() {
...
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-screen w-full overflow-hidden bg-navy-deep pt-24 text-cream", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: heroImg, alt: "", className: "absolute inset-0 h-full w-full object-cover opacity-25 animate-ken-burns" }),
      ...
      Array.from({
        length: 14
      }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `absolute h-1.5 w-1.5 rounded-full animate-float-dust ${i % 2 ? "bg-gold" : "bg-bm-blue"}`, style: {
        left: `${i * 53 % 100}%`,
        top: `${i * 37 % 100}%`,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 mx-auto grid max-w-7xl gap-12 px-6 pb-20 pt-10 lg:grid-cols-[1.05fr_1fr] lg:items-center lg:gap-12 lg:pt-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-reveal relative", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: lionUrl, alt: "", "aria-hidden": true, className: "pointer-events-none absolute -right-6 -top-10 hidden h-[260px] w-auto animate-lion-roar drop-shadow-[0_20px_50px_rgba(253,95,8,0.45)] md:block lg:-right-16 lg:top-0 lg:h-[340px]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-8 max-w-xl text-lg leading-relaxed text-cream/90 md:text-xl", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative animate-reveal", style: {
        animationDelay: "0.15s"
      }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: lionUrl, alt: "", "aria-hidden": true, className: "mx-auto -mb-4 block h-40 w-auto animate-lion-roar drop-shadow-[0_18px_40px_rgba(253,95,8,0.4)] md:hidden" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "relative rounded-3xl border border-cream/15 bg-navy/80 p-8 backdrop-blur-xl shadow-luxe md:p-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 grid gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", placeholder: "Your name", className: "w-full rounded-xl border border-cream/20 bg-cream/10 px-5 py-3.5 text-sm text-cream placeholder:text-cream/65 focus:border-gold focus:outline-none focus:bg-cream/15" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "email", placeholder: "Work email", className: "w-full rounded-xl border border-cream/20 bg-cream/10 px-5 py-3.5 text-sm text-cream placeholder:text-cream/65 focus:border-gold focus:outline-none focus:bg-cream/15" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", placeholder: "Company", className: "w-full rounded-xl border border-cream/20 bg-cream/10 px-5 py-3.5 text-sm text-cream placeholder:text-cream/65 focus:border-gold focus:outline-none focus:bg-cream/15" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", placeholder: "Title", className: "w-full rounded-xl border border-cream/20 bg-cream/10 px-5 py-3.5 text-sm text-cream placeholder:text-cream/65 focus:border-gold focus:outline-none focus:bg-cream/15" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { rows: 2, placeholder: "What do you want the world to hear?", className: "w-full rounded-xl border border-cream/20 bg-cream/10 px-5 py-3.5 text-sm text-cream placeholder:text-cream/65 focus:border-gold focus:outline-none focus:bg-cream/15" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", className: "group mt-1 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-gold px-6 py-4 text-sm font-bold uppercase tracking-wider text-navy-deep transition hover:bg-gold-soft hover:scale-[1.01]", children: [
              "Open The Mic",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-6 left-1/2 z-10 -translate-x-1/2 text-[10px] uppercase tracking-[0.4em] text-cream/45", children: "↓ The story starts here" })
  ] });
}
...
function ServicesRibbon() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative overflow-hidden border-y border-cream/5 bg-navy-deep py-6 text-cream", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex w-max gap-10 marquee", children: [...ribbonServices, ...ribbonServices].map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 whitespace-nowrap", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(DotMark, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-2xl font-bold uppercase tracking-tight text-cream/90 md:text-3xl", children: item })
  ] }, i)) }) });
}
...
function Story() {
  const [open, setOpen] = reactExports.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "story", className: "relative bg-white py-28 md:py-32", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto grid max-w-7xl items-center gap-16 px-6 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setOpen(true), className: "group relative block w-full overflow-hidden rounded-2xl shadow-luxe", "aria-label": "Play our story", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: storyThumb, alt: "The Big Mouth PR story", loading: "lazy", className: "h-[520px] w-full object-cover transition duration-700 group-hover:scale-105" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-5 font-display text-5xl font-black uppercase leading-[0.95] text-navy-deep md:text-6xl", children: [
          "Built for the ones ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          "who refuse to be the ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold italic", children: "best-kept secret." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-8 text-lg leading-relaxed text-navy/80", children: "Most agencies polish you until you're palatable. We do the opposite. We find the loudest, truest, most magnetic version of you — and we hand the world a megaphone." }),
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-[100] flex items-center justify-center bg-navy-deep/95 p-4 backdrop-blur", onClick: () => setOpen(false), children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-full max-w-5xl overflow-hidden rounded-2xl bg-black shadow-luxe", onClick: (e) => e.stopPropagation(), children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-video w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("iframe", { className: "h-full w-full", src: "https://www.youtube.com/embed/dQw4w9WgXcQ?autoplay=1", title: "The Big Mouth PR — Our Story", allow: "autoplay; encrypted-media; picture-in-picture", allowFullScreen: true }) }) })
    ] })
  ] });
}
function Stat({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-4xl font-bold text-navy-deep", children: n }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "services", className: "relative overflow-hidden bg-white py-24 text-navy-deep md:py-32", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-7xl px-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-14 grid gap-5 md:grid-cols-2 lg:grid-cols-3", children: serviceGroups.map((s) => {
        const Icon = s.icon;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "group relative overflow-hidden rounded-2xl border border-navy-deep/10 bg-navy-deep p-8 text-cream transition hover:border-gold hover:-translate-y-1 hover:shadow-luxe min-h-[380px] flex flex-col justify-end", children: [
...
function Industries() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "industries", className: "relative bg-white py-24 text-navy-deep md:py-32 border-t border-navy-deep/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start justify-between gap-6 md:flex-row md:items-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "inline-flex items-center gap-2 text-xs uppercase tracking-[0.4em] text-gold", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DotMark, {}),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-5 font-display text-5xl font-black uppercase leading-[0.95] text-navy-deep md:text-6xl", children: [
          "Built for every ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold italic", children: "loud leader." })
        ] })
      ] }),
...
function Portfolio() {
  const items = [{
    img: portfolio1,
    title: "CEO Editorial Shoot",
    tag: "Photography"
  }, {
    img: portfolio2,
    title: "Forbes Feature Placement",
    tag: "PR & Media"
  }, {
    img: portfolio3,
    title: "Keynote Speaker Kit",
    tag: "Brand Strategy"
  }, {
    img: portfolio4,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "portfolio", className: "bg-white py-28 md:py-32 border-t border-navy-deep/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start justify-between gap-6 md:flex-row md:items-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "inline-flex items-center gap-2 text-xs uppercase tracking-[0.4em] text-gold", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DotMark, {}),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-5 font-display text-5xl font-black uppercase leading-[0.95] text-navy-deep md:text-6xl", children: [
          "Quiet leaders. ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold italic", children: "Loud results." })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#consult", className: "group inline-flex items-center gap-2 text-sm uppercase tracking-[0.25em] text-navy-deep", children: [
        "View all work",
        /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-4 w-4 transition group-hover:translate-x-1" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-14 grid gap-5 md:grid-cols-12", children: items.map((it, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#", className: `group relative block overflow-hidden rounded-2xl shadow-luxe ${i === 0 ? "md:col-span-7 md:row-span-2" : i === 1 ? "md:col-span-5" : "md:col-span-5 md:col-start-8"}`, style: {
      minHeight: i === 0 ? 620 : 300
    }, children: [
...
const cases = [{
  ...
  note: "Featured in Forbes & WSJ in 6 months.",
  img: reel1
}, {
  client: "Daniel K.",
  role: "Healthcare CEO",
  ...
  note: "Keynote-circuit ready in 90 days.",
  img: reel2
}, {
  client: "Anika S.",
  ...
  note: "Audiobook + Kirkus Review launch.",
  img: reel3
}, {
  client: "Marcus T.",
  ...
  note: "Reputation cleanup + Wikipedia.",
  img: reel4
}];
function CaseStudies() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden bg-white py-24 text-navy-deep md:py-32 border-t border-navy-deep/5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-7xl px-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-5 max-w-3xl font-display text-5xl font-black uppercase leading-[0.95] text-navy-deep md:text-6xl", children: [
        "Real leaders. ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold italic", children: "Real noise." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-14 grid gap-5 md:grid-cols-2 lg:grid-cols-4", children: cases.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "group relative overflow-hidden rounded-2xl border border-navy-deep/10 bg-navy-deep text-cream transition hover:border-gold hover:-translate-y-1 hover:shadow-luxe", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-56 overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: c.img, alt: c.client, loading: "lazy", className: "h-full w-full object-cover transition duration-700 group-hover:scale-105" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-navy-deep via-navy-deep/40 to-transparent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-3 left-4 right-4 flex items-end justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-5xl font-black text-gold leading-none drop-shadow", children: c.metric }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-right text-[10px] uppercase tracking-[0.2em] text-cream/75", children: c.label })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-xl font-bold text-cream", children: c.client }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-cream/60", children: c.role }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm text-cream/80", children: c.note })
        ] })
      ] }, c.client)) })
    ] })
  ] });
...
function Testimonials() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden bg-navy-deep py-28 text-cream md:py-32", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-7xl px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between flex-wrap gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-5 font-display text-5xl font-black uppercase leading-[0.95] text-cream md:text-6xl", children: [
            "They ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-4", children: testimonials.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "group relative aspect-[9/16] overflow-hidden rounded-3xl bg-black shadow-luxe", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: t.img, alt: t.name, loading: "lazy", className: "absolute inset-0 h-full w-full object-cover transition duration-700 group-hover:scale-105" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-black via-black/30 to-black/60" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-x-0 top-0 p-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Quote, { className: "h-5 w-5 text-gold" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-2 font-display text-base italic leading-snug text-cream drop-shadow", children: [
            '"',
            t.quote,
            '"'
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute right-3 top-1/2 flex -translate-y-1/2 flex-col items-center gap-4 text-cream", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-10 w-10 place-items-center rounded-full bg-cream/15 backdrop-blur", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "h-4 w-4" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-10 w-10 place-items-center rounded-full bg-cream/15 backdrop-blur", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Volume2, { className: "h-4 w-4" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-1/2 top-[55%] -translate-x-1/2 -translate-y-1/2 grid h-14 w-14 place-items-center rounded-full bg-gold/95 text-navy-deep transition group-hover:scale-110", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "ml-0.5 h-6 w-6 fill-current" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-x-0 bottom-0 flex items-center gap-3 p-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: t.img, alt: "", className: "h-10 w-10 rounded-full border-2 border-gold object-cover" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-cream", children: t.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-cream/70", children: t.role })
          ] })
        ] })
      ] }, t.name)) })
    ] })
...
const faqs = [{
  ...
  a: "Founders, C-level executives, authors and high-profile professionals ready to be seen — not shy."
}, {
  q: "How long until I see results?",
  a: "Most clients see meaningful media or audience movement inside 60–90 days. Wikipedia and audiobooks take longer by design."
}, {
  q: "Do you offer one-off services or only retainers?",
  a: "Both. Pick a single service (LinkedIn build, ISBN registration) or a full personal-brand engagement."
}, {
  ...
  a: "Yes — discreetly. Crisis communications and online reputation management are core services."
}];
function FAQ() {
  const [open, setOpen] = reactExports.useState(0);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "faq", className: "bg-white py-28 md:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-6xl gap-16 px-6 lg:grid-cols-[1fr_1.4fr]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "inline-flex items-center gap-2 text-xs uppercase tracking-[0.4em] text-gold", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DotMark, {}),
        " FAQ"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-5 font-display text-5xl font-black uppercase leading-[0.95] text-navy-deep", children: [
        "Loud questions, ",
...
function platformIcon(p) {
  if (p === "linkedin") return /* @__PURE__ */ jsxRuntimeExports.jsx(Linkedin, { className: "h-4 w-4" });
...
function SocialFeed() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative overflow-hidden bg-white pb-28 md:pb-32 border-t border-navy-deep/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 pt-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start justify-between gap-6 md:flex-row md:items-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "inline-flex items-center gap-2 text-xs uppercase tracking-[0.4em] text-gold", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DotMark, {}),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#", className: "inline-flex items-center gap-2 rounded-full border border-navy-deep/15 px-5 py-2.5 text-sm font-semibold text-navy-deep transition hover:bg-navy-deep hover:text-cream", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-6", children: socialPosts.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#", className: "group relative aspect-square overflow-hidden rounded-2xl bg-navy-deep", children: [
...
function FinalCTA() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "consult", className: "relative overflow-hidden bg-navy-deep py-28 text-cream md:py-36", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-5xl px-6 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-6 font-display text-6xl font-black uppercase leading-[0.95] md:text-8xl", children: [
        "Ready to be ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
...
function Home() {
  const fontsRef = reactExports.useRef(false);
  reactExports.useEffect(() => {
