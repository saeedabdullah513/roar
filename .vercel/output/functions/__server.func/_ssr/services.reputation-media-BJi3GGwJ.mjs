...
import { S as SiteHeader, C as ClientsRibbon, F as Footer, a as FloatingCTA, L as LionInteractions, i as iconUrl, D as DotMark, M as MouthMark, b as svcMedia, s as svcExec } from "./router-DGUNaTGD.mjs";
...
import { V as Volume2, A as ArrowRight, f as ShieldCheck, N as Newspaper, T as TrendingUp, M as Megaphone, a as Crown, Y as MicVocal, e as Minus, P as Plus, d as Check, v as ArrowUpRight, h as Phone, w as ClipboardList, x as FilePenLine, U as Users, y as Map, R as Rocket, u as ChartLine, $ as Trophy, k as MessageSquareHeart, L as LoaderCircle } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "sub-services", className: "relative bg-[oklch(0.98_0.005_240)] py-20 md:py-24 xl:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-3 max-w-2xl font-display text-4xl font-black tracking-tight text-navy-deep md:text-5xl", children: "Six Ways to Build a Name That Doesn't Wash Off." })
      ] }),
