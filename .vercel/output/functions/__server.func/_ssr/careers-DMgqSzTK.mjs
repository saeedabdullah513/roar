...
import { S as SiteHeader, D as DotMark, F as Footer, a as FloatingCTA, L as LionInteractions } from "./router-BdSgIqBO.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "pb-20 md:pb-32", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-2xl px-6", children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center rounded-3xl bg-cream/5 p-12 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 grid gap-5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { required: true, name: "phone", type: "tel", className: "mt-1.5 w-full rounded-xl border border-cream/15 bg-navy-deep/40 px-4 py-3 text-sm text-cream placeholder:text-cream/45 focus:border-gold focus:outline-none", placeholder: "+1 (555) 000-0000" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block", children: [
