...
const appCss = "/assets/styles-BOFINWKI.css";
...
const $$splitComponentImporter$d = () => import("./thank-you-Bi_95P9H.mjs");
const Route$d = createFileRoute("/thank-you")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$c = () => import("./terms-BMN-IWXA.mjs");
...
const $$splitComponentImporter$b = () => import("./privacy-policy-DF_GcK6x.mjs");
...
const $$splitComponentImporter$a = () => import("./packages-BaMpcOWL.mjs");
const Route$a = createFileRoute("/packages")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$9 = () => import("./contact-us-CHmVHDtZ.mjs");
const Route$9 = createFileRoute("/contact-us")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$8 = () => import("./brand-strategy-BXtIq_en.mjs");
const Route$8 = createFileRoute("/brand-strategy")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$7 = () => import("./about-us-CFDfLzcz.mjs");
...
const $$splitComponentImporter$6 = () => import("./index-iWX4zFpZ.mjs");
...
const $$splitComponentImporter$5 = () => import("./services.reputation-media-BcjUEcL6.mjs");
...
const $$splitComponentImporter$4 = () => import("./services.executive-personal-branding-Dh_1H96Q.mjs");
...
const $$splitComponentImporter$3 = () => import("./services.digital-public-affairs-SFk6s5qG.mjs");
...
const $$splitComponentImporter$2 = () => import("./services.creative-production-DlXJQXE9.mjs");
...
const $$splitComponentImporter$1 = () => import("./services.content-social--75-acwQ.mjs");
...
const $$splitComponentImporter = () => import("./services.author-publishing-C06iFdof.mjs");
...
const ThankYouRoute = Route$d.update({
  id: "/thank-you",
  path: "/thank-you",
...
const PackagesRoute = Route$a.update({
  id: "/packages",
  path: "/packages",
  getParentRoute: () => Route$e
});
const ContactUsRoute = Route$9.update({
  id: "/contact-us",
  path: "/contact-us",
  getParentRoute: () => Route$e
});
const BrandStrategyRoute = Route$8.update({
  id: "/brand-strategy",
  path: "/brand-strategy",
  getParentRoute: () => Route$e
});
