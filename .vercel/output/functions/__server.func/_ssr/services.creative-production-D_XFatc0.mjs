...
import { S as SiteHeader, C as ClientsRibbon, F as Footer, a as FloatingCTA, L as LionInteractions, i as iconUrl, D as DotMark, M as MouthMark, s as svcExec, e as svcAuthor } from "./router-FPk8vJkk.mjs";
...
import { p as portfolio4 } from "./portfolio-4-D8RG1HsP.mjs";
import "../_libs/seroval.mjs";
import { V as Volume2, A as ArrowRight, b as Camera, a5 as Film, a6 as Palette, S as Sparkles, a7 as Printer, a0 as Gift, a2 as Monitor, a8 as Scissors, e as Minus, P as Plus, d as Check, v as ArrowUpRight, h as Phone, w as ClipboardList, x as FilePenLine, U as Users, y as Map, R as Rocket, u as ChartLine, $ as Trophy, k as MessageSquareHeart, L as LoaderCircle } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "sub-services", className: "relative bg-[oklch(0.98_0.005_240)] py-20 md:py-24 xl:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-3 max-w-2xl font-display text-4xl font-black tracking-tight text-navy-deep md:text-5xl", children: "A Team That Handles it All." })
      ] }),
        ...
        isOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 border-t border-navy-deep/10 px-6 py-7 md:grid-cols-[1.4fr_1fr] md:px-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start justify-between gap-4 rounded-xl bg-navy-deep p-6 text-cream", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-cream/75", children: [
              ...
              " is full deliverables, samples and pricing."
            ] }),
