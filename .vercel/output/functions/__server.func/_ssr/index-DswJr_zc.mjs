...
import { l as logoUrl, N as NavigationMenu, g as NavigationMenuList, h as cn, j as NavigationMenuItem, k as NavigationMenuLink, s as svcExec, b as svcMedia, c as svcContent, d as svcCreative, e as svcAuthor, f as svcDigital, i as iconUrl, r as roarSfx } from "./router-FPk8vJkk.mjs";
...
import { c as Menu, C as ChevronDown, V as Volume2, a as Crown, N as Newspaper, M as Megaphone, b as Camera, B as BookOpen, E as Earth, S as Sparkles, g as Star, L as LoaderCircle, A as ArrowRight, z as Play, X, J as ChevronLeft, K as ChevronRight, O as UtensilsCrossed, T as TrendingUp, f as ShieldCheck, H as Heart, Q as Building2, W as Scale, Y as MicVocal, Z as Quote, e as Minus, P as Plus, I as Instagram, G as Linkedin, _ as Youtube } from "../_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-7xl items-center gap-3 px-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(NavigationMenu, { className: "hidden max-w-none flex-1 items-center justify-center rounded-full bg-white px-3 py-2 shadow-luxe lg:flex", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(NavigationMenuList, { className: "flex-1 items-center justify-center gap-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-0 top-full z-50 mt-1.5 hidden rounded-md border bg-white p-3 shadow-lg group-hover:block", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid w-[260px] gap-0.5 md:w-[460px] md:grid-cols-2", children: serviceLinks.map((s) => {
            const Icon = s.icon;
