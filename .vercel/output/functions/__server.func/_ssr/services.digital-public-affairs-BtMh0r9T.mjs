...
import { V as Volume2, A as ArrowRight, a4 as Monitor, t as ChartColumn, n as Users, a5 as Globe, M as Megaphone, a6 as Languages, e as Minus, P as Plus, d as Check, g as ArrowUpRight, h as Phone, w as ClipboardList, x as FilePenLine, y as Map, R as Rocket, v as ChartLine, a1 as Trophy, k as MessageSquareHeart, K as ChevronLeft, O as ChevronRight, L as LoaderCircle } from "../_libs/lucide-react.mjs";
...
function Overview() {
  const pillars = [{
    ...
    icon: ChartColumn,
    t: "Media Buying",
    d: "Strategic placement, negotiation and optimization across every channel."
  }, {
    icon: Users,
    ...
    d: "Professional translation and localization for 40+ languages and markets."
  }];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative bg-white py-20 md:py-24 xl:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid items-end gap-10 lg:grid-cols-[1.2fr_1fr]", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-navy-deep/70 md:text-lg", children: "Digital & Public Affairs is where marketing meets advocacy. We build integrated campaigns that move both consumers and policy — spanning paid media, organic content, government relations and multilingual localization." })
    ] }),
...
const subServices = [{
  ...
  details: ["Paid search & SEO strategy", "Social media advertising (Meta, LinkedIn, X, TikTok)", "Programmatic display & video", "Email marketing & marketing automation", "Conversion rate optimization & landing page design"]
}, {
  icon: ChartColumn,
  title: "Media Buying",
  ...
  details: ["Custom website design & development", "Landing page optimization & A/B testing", "CMS integration (WordPress, Webflow, HubSpot)", "SEO architecture & technical audits", "Ongoing maintenance & performance monitoring"]
}, {
  icon: Users,
  ...
  details: ["Community needs assessment & strategy", "Local partnership development", "Corporate volunteering & grant programs", "Town halls, roundtables & public meetings", "Community impact measurement & reporting"]
}, {
  icon: Languages,
  title: "Translation & Localisation",
  short: "Explore Translation & Localization in more detail.",
  details: ["Professional human translation + AI-assisted workflows", "Marketing & creative localization", "Website, app & software localization", "Subtitling, voice-over & multimedia translation", "Cultural consultancy & market entry support"]
}];
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "sub-services", className: "relative bg-[oklch(0.98_0.005_240)] py-20 md:py-24 xl:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-3 max-w-2xl font-display text-2xl sm:text-3xl md:text-5xl font-black tracking-tight text-navy-deep md:text-5xl", children: "Your Only Team to Handle it All." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-sm text-sm text-navy-deep/65", children: "Pick one service or take the full suite. The Big Mouth PR offers expertise in each one:" })
    ] }),
