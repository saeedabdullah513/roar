...
import { p as logoUrl, N as NavigationMenuItem, q as cn, s as svcExec, b as svcMedia, c as svcContent, d as svcCreative, e as svcAuthor, f as svcDigital, r as heroImg, i as iconUrl, g as caseTerraSquare, h as caseUsaToday, j as caseForbes, k as caseBrandBook, t as roarSfx } from "./router-BDpAQETN.mjs";
...
import { c as Menu, C as ChevronDown, V as Volume2, a as Crown, N as Newspaper, M as Megaphone, b as Camera, B as BookOpen, E as Earth, S as Sparkles, J as Star, L as LoaderCircle, A as ArrowRight, z as Play, X, K as ChevronLeft, O as ChevronRight, Q as UtensilsCrossed, T as TrendingUp, W as ShieldCheck, H as Heart, Y as Building2, Z as Scale, _ as MicVocal, e as Minus, P as Plus, I as Instagram, $ as Youtube } from "../_libs/lucide-react.mjs";
          ...
          heroDone ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-10 text-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 grid gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "tel", required: true, value: heroForm.phone, onChange: heroUpdate("phone"), onInput: (e) => {
                  e.target.value = e.target.value.replace(/[^\d+]/g, "");
                }, placeholder: "Phone", className: "w-full rounded-xl border border-cream/20 bg-cream/10 px-5 py-3.5 text-sm text-cream placeholder:text-cream/65 focus:border-gold focus:outline-none focus:bg-cream/15" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
...
function Services() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "services", className: "relative overflow-hidden bg-white py-12 md:py-20 text-navy-deep md:py-24 xl:py-20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-7xl px-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-14 grid gap-5 md:grid-cols-2 lg:grid-cols-3", children: serviceGroups.filter((s) => s.title !== "Events & Experiential Marketing").map((s) => {
        const Icon = s.icon;
...
const faqs = [{
  ...
  a: "Leaders who are tired of being overlooked. Founders, executives, authors, public figures, and people who have earned their reputation and are ready to make sure the right rooms know it."
}, {
