...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CJdfP4_g.mjs");
...
const manifest = {
  "51496c6ca2b5055341948a46205d4083f7301883d1e1b16d00d2abd04c02d91c": {
    ...
    importer: () => import("./contact.functions-B6SvPICr.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-PuIKTmEh.mjs").then((n) => n.r),
    import("./start-BLb4Ynul.mjs"),
